...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('admin')->group(function () {
      ...
      Route::prefix('management')->group(function () {
          //cpu管理
          Route::get('/cpu/list','CpuManagementController@index')->name('cpu_index');
          ...
          //部署管理
          Route::get('/department/list','DepartmentManagementController@index')->name('department_index');
          ...
          //保管場所管理
          Route::get('/depository/list','DepositoryManagementController@index')->name('depository_index');
          ...
          //社員管理
          Route::get('/employee/list','EmployeeManagementController@index')->name('employee_index');
          ...
          //端末情報管理
          Route::get('/terminal/list','TerminalManagementController@index')->name('terminal_info_index');
          ...
          //office情報管理
          Route::get('/office/list','OfficeManagementController@index')->name('office_index');
