    ...
    <div class="form-panel">
      <h1 class="mb">利用状況登録画面</h1>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
                      <label class="col-sm-2 control-label">利用状況</label>
                   <div class="radio">
    ...
    <script>
        $(function(){
            ...
            $('#clearForm').bind('click', function(event) {
                ...
                // $('input:radio[name="status"]').prop('checked',true);
                    // $("input:radio[name='status'][value='2']").attr('checked', true);
            });
            // $(this.form).find(":radio['name'=>'status:eq(0)]'").prop("checked",false);
            // $(this.form).find(":radio['name'=>'status:eq(1)]'").prop("checked", true);
       });
    </script>
@endsection
